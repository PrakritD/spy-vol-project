...
(Diebold-Mariano p = 1.2 × 10⁻⁵), and beats plain HAR by **8.9%**. The improvement holds in
...
- **Evaluation window**: every model must have a finite CRPS that day, so every comparison
  runs on the identical 3,348-day sample (2013-02-06 → 2026-05-29).
...
Mean CRPS by model and regime (lower is better; common 3,348-day evaluation window, 95% CI
from Newey-West SE):
...
(p = 0.021) and 2020-21 (p < 0.001), and dramatically worse in 2020-21 specifically, where a
small, monthly-refit net evidently struggled with the regime's volatility-of-volatility.
